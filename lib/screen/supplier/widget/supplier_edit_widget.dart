...
class SupplierEdit extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final companyController = TextEditingController(text: currentSupplier.companyName);
    final contactController = TextEditingController(text: currentSupplier.contactPerson);
    final phoneController = TextEditingController(text: currentSupplier.phone);
    final emailController = TextEditingController(text: currentSupplier.email);
    final addressController = TextEditingController(text: currentSupplier.address);
    
    final RxBool isCheckedStatus = currentSupplier.status.obs;
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Edit Supplier Details', style: TextStyle(color: Color(0xFF003865), fontWeight: FontWeight.bold, fontSize: 16)),
      ),
          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  const Text('Account Activation Status', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: Color(0xFF374151))),
                  Obx(() => Switch(
                    value: isCheckedStatus.value,
                    activeThumbColor: const Color(0xFF10B981),
                    onChanged: (val) => isCheckedStatus.value = val,
                  )),
                ],
              ),
                ...
                children: [
                  ...
                  Expanded(
                    child: ElevatedButton(
                      onPressed: () async {
                        await ctr.updateSupplier(SupplierModel(
